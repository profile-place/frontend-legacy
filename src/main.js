...
Vue.use(Tailwind, {
	...
	TButton: {
		...
		variants: {
			...
			error: 'text-white bg-red-600 hover:bg-red-500 focus:border-red-700active:bg-red-700 text-sm font-medium border border-transparent px-3 py-2 rounded-md',
	...
	TAlert: {
		...
		variants: {
			...
			success: {
				...
				body: 'text-green-700',
				close: 'text-green-700hover:text-green-500 hover:bg-green-200'
			}
		}
	},
	TCard: {
